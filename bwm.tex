...
\begin{align*}
	d &\equiv \left(i_1 + i_9 + \sum_{k=1}^{8} i_{k+1} - i_k\right) \pmod 2 \\
	&\equiv \biggl(i_1 + i_9 + (i_2 - i_1) + (i_3 - i_2) + (i_4 - i_3) + (i_5 - i_4) \\
	&+ (i_6 - i_5) + (i_7 - i_6) + (i_8 - i_7) + (i_9 - i_8)\biggr) \pmod 2 \\
	&\equiv \biggl(i_1 - i_1 + i_2 - i_2 + i_3 - i_3 + i_4 - i_4 + i_5 - i_5 + i_6 - i_6 \\
	&+ i_7 - i_7 + i_8 - i_8 + i_9 + i_9\biggr) \pmod 2 \\
	&\equiv (2 i_9) \pmod 2
\end{align*}
...
\begin{samepage}
	...
	\begin{align*}
		...
		&= \frac{R \sin\beta}{(R-\frac{R \sin\beta}{1+\sin\beta})(1+\cos\beta)(1+\sin\beta)} \tag{??} \\
		&= \frac{R \sin\beta}{(\frac{R}{1+\sin\beta})(1+\cos\beta)(1+\sin\beta)} \tag{->??} \\
