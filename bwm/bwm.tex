...
Um zu beweisen, dass für die Gesamtdistanz keine ungerade Strecke herauskommen kann, wird "die Parität gebildet" (formulierung verbessern):
\begin{align*}
...
\begin{itemize}
	\item[b)] Die zurückgelegte Strecke kann also nie $25$ Längeneinheiten betragen.
\end{itemize}
...
\begin{multicols}{2}
	...
	\end{equation*}
\end{multicols}
$\dots$ steht hierbei für beliebig viele Ziffern, die für die Bestimmung der letzten Nichtnull-Ziffer irrelevant sind. \\[10pt]
...
\begin{equation*}
	\begin{split}
		LZ(n!) &= LZ\left(2^m \cdot m!\right)
	\end{split}
\end{equation*}
für $m = \lfloor\frac{n}{5}\rfloor$.

<nur noch absatz über sich wiederholende folge der zweierpotenzen (alle gerade) -> gerade * gerade = gerade, folglich für immer 2, 4, 6 und 8 :)
